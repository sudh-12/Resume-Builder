...
//     // });
//   axios.get(`/fetch-pdf?email=${this.props.user.email}`).then((res) => {
//     if (res.data.fileUrl) {
...
//   try {
//     // Create a full data object with all resume data
//     const resumeData = {
//       ...this.state,
//       email: this.props.user.email
//     };

//     // Send the full resume data to create the PDF
//     const createPdfResponse = await axios.post("/create-pdf", resumeData);
...
//     axios.get(`/fetch-pdf?email=${this.props.user.email}`)
//       .then((res) => {
//         if (res.data.fileUrl) {
//           this.setState({ resumeUrl: res.data.fileUrl });
//         } else {

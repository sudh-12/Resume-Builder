  ...
  <!DOCTYPE html>
	...
	* {
	  ...
	  .page {
        ...
        margin: 0;
        padding: 10px; /* Optional: for content margins */
        box-sizing: border-box;
	  }
	  .top-bar {
		height: 170px;
	  ...
	  .name {
		...
		letter-spacing: 8px;
		font-weight: 100;
		line-height: 5.5; /* Adjust this value to prevent collision */
        padding: 30px;
		font-style: normal;
	  }
	  .name div {
	...
	.firstname {
		...
		line-height: 1.2; /* Adjust line height to prevent collision */
	}
	.lastname {
		font-size: 40px; /* Same font size for consistency */
		line-height: 1.2; /* Adjust line height to prevent collision */
	}
	  .greyed {

# Resume Builder Application : [TRY LIVE ](https://resume-builder-lemon-one.vercel.app/ "Live Website")
...
3. **Google Oauth2.0** for google sign-up and login.
4. **AWS S3** for storage of resume as a pdf.
